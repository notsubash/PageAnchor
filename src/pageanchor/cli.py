...
def main(argv: list[str] | None = None) -> int:
    ...
    ask_parser.add_argument("--mode", default="text")
    ...
    eval_parser.add_argument("--modes", default="text,text+verify")
    ...
    if args.cmd == "ingest":
        ...
        for result in ingest_all(doc_id=args.doc_id, all_docs=args.all):
